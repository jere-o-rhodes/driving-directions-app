...
# load locations
locations <- read_csv("doctors-locations.csv")
...
locations <- locations %>%
  st_as_sf(coords = c("longitude","latitude"), # use names for columns with lat and long if you have already and don't need geocoding step
